...
export const PICKED_LIST_RPOPS = ['_id', 'uuid', 'tabs', 'title', 'tags', 'time', 'pinned', 'expand', 'color', 'updatedAt']
export const SYNCED_LIST_PROPS = ['_id', 'uuid', 'tabs', 'title', 'tags', 'time', 'pinned', 'expand', 'color', 'updatedAt']
